...
const AdminContestCard = React.memo(({ contest, type, onEditClick, onDeleteClick, onLiveEditClick, onLeaderBoardClick }) => {
  // useEffect(()=>{
...
//     flex justify-between items-center gap-6 cursor-pointer
//     transition-all duration-300 hover:scale-[1.04] hover:shadow-xl hover:border-blue-400"
//   >
//     {/* Left Section */}
//     <div className="flex flex-col  gap-3 ">
//       <h4 className="text-xl font-bold text-gray-800 tracking-wide mb-1 text-center">
//         {contest.name}
//       </h4>
...
//           <button
//             title="Edit"
//             className="px-3 py-1.5 rounded-xl bg-blue-100 text-blue-600 hover:bg-blue-200 transition flex items-center justify-center gap-1"
//             onClick={() => onLiveEditClick(contest.id)}
//           >
//             <EditIcon size={18} />
//           </button>
//           <button
//             title="LeaderBoard"
//             className="px-3 py-1.5 rounded-xl bg-violet-100 text-violet-600 hover:bg-violet-200 transition flex items-center justify-center gap-1"
...
//           <button
//             title="End Contest"
//             className="px-3 py-1.5 rounded-xl bg-red-100 text-red-600 hover:bg-red-200 transition flex items-center justify-center gap-1"
//           >
