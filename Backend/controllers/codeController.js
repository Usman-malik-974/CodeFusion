...
function getCppContainer() {
  const name = cppContainers[currentCpp];
  currentCpp = (currentCpp + 1) % cppContainers.length;
  return name;
}
...
exports.runTestCases = async (req, res, io) => {
  ...
  const tempFolders = {
    "cpp-runner-1": "D:/Projects/CodeFusion/Backend/temp1",
    "cpp-runner-2": "D:/Projects/CodeFusion/Backend/temp2",
    "cpp-runner-3": "D:/Projects/CodeFusion/Backend/temp3",
  };
  ...
  switch (language) {
    ...
    // case 'cpp': {
    //   fileName = 'main.cpp';
    //   containerName = getCppContainer(); // choose one
    //   const localPath = path.join(tempFolders[containerName], jobId);
